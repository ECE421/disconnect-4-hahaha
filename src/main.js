...
var nodeNet = require('net');(function(undefined) {
  // @note
...
/* Generated by Opal 0.10.6 */
Opal.modules["proton_app"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$lambda']);
  return (function($base) {
    var $Proton, self = $Proton = $module($base, 'Proton');
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
        ...
        return self.app = electron.app;
      }, TMP_1.$$arity = 0);

      Opal.defn(self, '$on', TMP_2 = function $$on(event) {
        var self = this, $iter = TMP_2.$$p, callback = $iter || nil;

        TMP_2.$$p = null;
        return self.app.on(event, callback);
      }, TMP_2.$$arity = 1);

      Opal.defn(self, '$on_window_all_closed', TMP_4 = function $$on_window_all_closed() {
        var $a, $b, TMP_3, self = this, $iter = TMP_4.$$p, $yield = $iter || nil, closed_ = nil;

        TMP_4.$$p = null;
        closed_ = ($a = ($b = self).$lambda, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return Opal.yieldX($yield, []);}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($b);
        return self.app.on('window-all-closed', closed_);
      }, TMP_4.$$arity = 0);

      Opal.defn(self, '$on_ready', TMP_6 = function $$on_ready() {
        var $a, $b, TMP_5, self = this, $iter = TMP_6.$$p, $yield = $iter || nil, ready_ = nil;

        TMP_6.$$p = null;
        ready_ = ($a = ($b = self).$lambda, $a.$$p = (TMP_5 = function(launch_info){var self = TMP_5.$$s || this;
if (launch_info == null) launch_info = nil;
        return Opal.yield1($yield, launch_info);}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5), $a).call($b);
        return self.app.on('ready', ready_);
      }, TMP_6.$$arity = 0);

      return (Opal.defn(self, '$quit', TMP_7 = function $$quit() {
        var self = this;

        return self.app.quit();
      }, TMP_7.$$arity = 0), nil) && 'quit';
    })($scope.base, null)
  })($scope.base)
};
...
/* Generated by Opal 0.10.6 */
Opal.modules["proton_global"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$from_window', '$is_a?', '$to_js', '$raise', '$to_n']);
  self.$require("native");
  (function($base, $super) {
    function $MainWindowAssignementError(){};
    var self = $MainWindowAssignementError = $klass($base, $super, 'MainWindowAssignementError', $MainWindowAssignementError);
  ...
  return (function($base, $super) {
    function $Global(){};
    var self = $Global = $klass($base, $super, 'Global', $Global);
    ...
    return (function(self) {
      ...
      Opal.defn(self, '$main_window', TMP_1 = function $$main_window() {
        var self = this;

        return (($scope.get('Proton')).$$scope.get('BrowserWindow')).$from_window(global.mainWindow);
      }, TMP_1.$$arity = 0);
      Opal.defn(self, '$main_window=', TMP_2 = function(obj) {
        var $a, self = this;

        if (obj !== false && obj !== nil && obj != null) {
          if ((($a = obj['$is_a?']((($scope.get('Proton')).$$scope.get('BrowserWindow')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            return global.mainWindow = obj.$to_js();
            } else {
            return self.$raise($scope.get('MainWindowAssignementError'))
          }
          } else {
          return global.mainWindow = obj;
        };
      }, TMP_2.$$arity = 1);
      return (Opal.defn(self, '$ready=', TMP_3 = function(obj) {
        var self = this;

        return global.ready = obj.$to_n();
      }, TMP_3.$$arity = 1), nil) && 'ready=';
    })(Opal.get_singleton_class(self))
  })($scope.base, null);
};

/* Generated by Opal 0.10.6 */
Opal.modules["proton_process"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;
  ...
  return (function($base, $super) {
    ...
    return (function(self) {
      ...
      Opal.defn(self, '$on', TMP_1 = function $$on(event) {
        var self = this, $iter = TMP_1.$$p, callback = $iter || nil;

        TMP_1.$$p = null;
        return process.on(event, callback);
      }, TMP_1.$$arity = 1);
      return (Opal.defn(self, '$platform', TMP_2 = function $$platform() {
        var self = this;

        return process.platform;
      }, TMP_2.$$arity = 0), nil) && 'platform';
    })(Opal.get_singleton_class(self))
  })($scope.base, null)
};

/* Generated by Opal 0.10.6 */
Opal.modules["proton"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$require', '$new']);
  self.$require("opal");
  self.$require("proton_app");
  self.$require("proton_global");
  self.$require("proton_process");
  return (function($base) {
    var $Proton, self = $Proton = $module($base, 'Proton');

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    Opal.defs(self, '$app', TMP_1 = function $$app() {
      var self = this;

      return (($scope.get('Proton')).$$scope.get('App')).$new();
    }, TMP_1.$$arity = 0)
  })($scope.base);
};

/* Generated by Opal 0.10.6 */
Opal.modules["proton/web_contents"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$each', '$<<', '$new', '$content', '$==', '$size', '$shift']);
  self.$require("native");
  return (function($base) {
    var $Proton, self = $Proton = $module($base, 'Proton');
    ...
    (function($base, $super) {
      ...
      var self = $BrowserWindow = $klass($base, $super, 'BrowserWindow', $BrowserWindow);

      var def = self.$$proto, $scope = self.$$scope;

      return (function($base, $super) {
        function $WebContents(){};
        var self = $WebContents = $klass($base, $super, 'WebContents', $WebContents);
        ...
        (function(self) {
          ...
          Opal.defn(self, '$get_all_web_contents', TMP_2 = function $$get_all_web_contents() {
            var $a, $b, TMP_1, self = this, arr = nil, wcs = nil;

            $a = [[], webContents.getAllWebContents()], arr = $a[0], wcs = $a[1], $a;
            ($a = ($b = ($range(0, wcs.length, true))).$each, $a.$$p = (TMP_1 = function(i){var self = TMP_1.$$s || this;
if (i == null) i = nil;
            return arr['$<<']($scope.get('WebContents').$new(wcs[i]))}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
            return arr;
          }, TMP_2.$$arity = 0);
          Opal.defn(self, '$get_focused_web_contents', TMP_3 = function $$get_focused_web_contents() {
            var self = this, wc = nil;

            wc = webContents.getFocusedWebContents();
            if (wc !== false && wc !== nil && wc != null) {
              return $scope.get('WebContents').$new(wc)
              } else {
              return nil
            };
          }, TMP_3.$$arity = 0);
          return (Opal.defn(self, '$from_id', TMP_4 = function $$from_id(id) {
            var self = this, wc = nil;
          ...
          }, TMP_4.$$arity = 1), nil) && 'from_id';
        })(Opal.get_singleton_class(self));

        Opal.defn(self, '$id', TMP_5 = function $$id() {
          var self = this;

          return self.$content().id;
        }, TMP_5.$$arity = 0);

        Opal.defn(self, '$session', TMP_6 = function $$session() {
          var self = this;

          return self.$content().session;
        }, TMP_6.$$arity = 0);

        Opal.defn(self, '$host_web_contents', TMP_7 = function $$host_web_contents() {
          var self = this;

          return self.$content().hostWebContents;
        }, TMP_7.$$arity = 0);

        Opal.defn(self, '$dev_tools_web_contents', TMP_8 = function $$dev_tools_web_contents() {
          var self = this;

          return self.$content().devToolsWebContents;
        }, TMP_8.$$arity = 0);

        Opal.defn(self, '$debugger', TMP_9 = function() {
          var self = this;

          return self.$content().debugger;
        }, TMP_9.$$arity = 0);

        Opal.defn(self, '$initialize', TMP_10 = function $$initialize(content) {
          var self = this;

          return self.content = content;
        }, TMP_10.$$arity = 1);

        return (Opal.defn(self, '$send', TMP_11 = function $$send(chan, $a_rest) {
          var self = this, rest;
          ...
          if (rest.$size()['$=='](0)) {
            return self.$content().send(chan);
          } else if (rest.$size()['$=='](1)) {
            return self.$content().send(chan, rest.$shift());
            } else {
            return self.$content().send(chan, rest);
          };
        }, TMP_11.$$arity = -2), nil) && 'send';
      })($scope.base, null)
    })($scope.base, null)
  })($scope.base);
};
...
/* Generated by Opal 0.10.6 */
Opal.modules["proton/browser_window"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $module = Opal.module;

  Opal.add_stubs(['$require', '$is_a?', '$alloc', '$to_js', '$raise', '$to_n', '$allocate', '$initialize', '$new', '$lambda']);
  self.$require("native");
  self.$require("proton/web_contents");
  (function($base, $super) {
    function $FromWindowAssignementError(){};
    var self = $FromWindowAssignementError = $klass($base, $super, 'FromWindowAssignementError', $FromWindowAssignementError);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11;

      def.window = def.web_contents = nil;
      (function(self) {
        var $scope = self.$$scope, def = self.$$proto, TMP_1, TMP_2, TMP_3;

        Opal.defn(self, '$from_window', TMP_1 = function $$from_window(window) {
          var $a, self = this;

          if ((($a = window['$is_a?']((($scope.get('Proton')).$$scope.get('BrowserWindow')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            return self.$alloc(window.$to_js())
            } else {
            return self.$raise($scope.get('FromWindowAssignementError'))
          };
        }, TMP_1.$$arity = 1);
        Opal.defn(self, '$new', TMP_2 = function(options) {
          var self = this;

          return self.$alloc(new BrowserWindow(options.$to_n()));
        }, TMP_2.$$arity = 1);
        return (Opal.defn(self, '$alloc', TMP_3 = function $$alloc(var$) {
          var self = this, browser_window = nil;

          browser_window = self.$allocate();
          browser_window.$initialize(var$);
          return browser_window;
        }, TMP_3.$$arity = 1), nil) && 'alloc';
      })(Opal.get_singleton_class(self));

      Opal.defn(self, '$initialize', TMP_4 = function $$initialize(window) {
        var self = this;

        self.window = window;
        return self.web_contents = $scope.get('WebContents').$new(self.window.webContents);
      }, TMP_4.$$arity = 1);

      Opal.defn(self, '$web_contents', TMP_5 = function $$web_contents() {
        var self = this;

        return self.web_contents;
      }, TMP_5.$$arity = 0);

      Opal.defn(self, '$on_closed', TMP_7 = function $$on_closed() {
        var $a, $b, TMP_6, self = this, $iter = TMP_7.$$p, $yield = $iter || nil, closed_ = nil;

        TMP_7.$$p = null;
        closed_ = ($a = ($b = self).$lambda, $a.$$p = (TMP_6 = function(event){var self = TMP_6.$$s || this;
if (event == null) event = nil;
        return Opal.yield1($yield, event);}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($b);
        return self.window.on('closed', closed_);
      }, TMP_7.$$arity = 0);

      Opal.defn(self, '$load_url', TMP_8 = function $$load_url(url) {
        var self = this;

        return self.window.loadURL(url);
      }, TMP_8.$$arity = 1);

      Opal.defn(self, '$close', TMP_9 = function $$close() {
        var self = this;

        return self.window.close();
      }, TMP_9.$$arity = 0);

      Opal.defn(self, '$toggle_dev_tools', TMP_10 = function $$toggle_dev_tools() {
        var self = this;

        return self.window.toggleDevTools();
      }, TMP_10.$$arity = 0);

      return (Opal.defn(self, '$to_js', TMP_11 = function $$to_js() {
        var self = this;

        return self.window;
      }, TMP_11.$$arity = 0), nil) && 'to_js';
    })($scope.base, null)
  })($scope.base);
};
...
(function(Opal) {
  ...
  return (($d = [($f = ($g = ((($scope.get('Proton')).$$scope.get('BrowserWindow')).$new($hash2(["width", "height"], {"width": 800, "height": 600})))).$tap, $f.$$p = (TMP_3 = function(window){var self = TMP_3.$$s || this, $h, $i, TMP_4;
if (window == null) window = nil;
    window.$load_url("file://" + (__dirname) + "/index.html");
      return ($h = ($i = window).$on_closed, $h.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $j, $k;

      return (($j = [nil]), $k = $scope.get('Global'), $k['$main_window='].apply($k, $j), $j[$j.length-1])}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $h).call($i);}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $f).call($g)]), $e = $scope.get('Global'), $e['$main_window='].apply($e, $d), $d[$d.length-1])}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c);
})(Opal);
